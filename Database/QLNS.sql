...
CONSTRAINT TENSACH_fk FOREIGN KEY (TENSACH)
REFERENCES SACH(TENSACH)
)
go
...
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('A010',N'Ngụ ngôn thế giới hay nhất - Tập 2','2020-11-08',116000,'TT','KD')
...
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('B007',N'Chuyến tàu mồ côi','2020-09-13',130000,'VH','TRE')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('B008',N'Chuyện về Bailey - Chú chó trong tiểu thuyết','2020-02-02',80000,'VH','TRE')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('B009',N'Thả thính chân kinh','2020-08-07',95000,'VH','TRE')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('B010',N'Chuyện may rủi','2020-05-17',115000,'VH','TRE')

INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C001',N'Danh ngôn Hồ Chí Minh','2010-03-08',75000,'CN','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C002',N'Học tập qua dự án','2020-05-26',140000,'KNS','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C003',N'Giảng văn Văn học Việt Nam','2006-03-29',48000,'VH','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C004',N'Bình giảng Văn 7','2018-05-30',19500,'VH','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C005',N'Phân tích bình giảng tác phẩm văn học Nâng cao 11','2018-05-22',40000,'VH','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C006',N'Thực hành kỹ năng sống dành cho học sinh lớp 1','2015-08-18',21500,'KNS','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C007',N'Tuyển tập truyện viết cho thiếu nhi từ sau CMT8','2015-08-06',20000,'VH','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C008',N'Bình giảng 31 tác phẩm văn học Ngữ văn 6','2012-04-16',4000,'VH','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C009',N'Phương pháp luận nghiên cứu văn học','2012-05-15',79000,'VH','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C010',N'Lịch sử văn học Trung Quốc','2002-05-17',20000,'VH','GD')

INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D001',N'Nhớ và quên','2018-12-03',88000,'VH','TH')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D002',N'Câu chuyện văn hóa','2019-02-19',120000,'VH','TH')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D003',N'Sự sống bất tử','2019-03-27',98000,'VH','TH')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D004',N'Con ơi, ba mẹ vẫn chờ','2020-09-01',64000,'MVB','TH')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D005',N'Để làm gì - Tạp bút','2020-02-08',120000,'KNS','TH')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D006',N'Ngàn cánh sen xanh biếc','2020-07-15',50400,'KNS','TH')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D007',N'Con người trong vòng vây','2016-11-18',64000,'KNS','TH')

INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E001',N'Cuộc chơi khởi nghiệp','2012-12-15',109000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E002',N'Kiếm tiền siêu tốc','2013-05-14',110000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E003',N'Tiếng Trung giao tiếp trong kinh doanh','2020-05-13',139000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E004',N'Sách của những câu hỏi','2016-05-12',68500,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E005',N'Người thành công có 1% suy nghĩ khác bạn','2016-09-11',80000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E006',N'Quyết tâm thành công sẽ tới','2017-04-10',60000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E007',N'Điểm mù - Tái bản','2017-03-09',89000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E008',N'Cuộc chơi đầu tư mạo hiểm','2013-06-08',85000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E009',N'Nghệ thuật lắng nghe trong giao tiếp','2020-07-06',129000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E010',N'Cư xử như đàn bà, suy nghĩ như đàn ông - Tái bản','2017-04-05',82000,'KNS','TN')

INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('XXXX',N'Hãy chọn mã sách ','2019-02-03',0,'MVB','DT')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('F001',N'Đắc nhân tâm','2017-12-09',47000,'KNS','DT')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('F002',N'Đắc nhân tâm - Bản đặc biệt','2019-04-30',150000,'KNS','DT')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('F003',N'Hỏi xoắn đáp cong','2017-10-26',76000,'KNS','DT')
