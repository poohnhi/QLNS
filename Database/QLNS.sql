...
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('B007',N'Chuyến tàu mồ côi','2020',130000,'VH','TRE')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('B008',N'Chuyện về Bailey - Chú chó trong tiểu thuyết','2020',80000,'VH','TRE')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('B009',N'Thả thính chân kinh','2020',95000,'VH','TRE')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('B010',N'Chuyện may rủi','2020',115000,'VH','TRE')


INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C001',N'Danh ngôn Hồ Chí Minh','2010-03-08',75000,'CN','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C002',N'Học tập qua dự án','2020-05',140000,'KNS','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C003',N'Giảng văn Văn học Việt Nam','2006-03',48000,'VH','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C004',N'Bình giảng Văn 7','2018-05',19500,'VH','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C005',N'Phân tích bình giảng tác phẩm văn học Nâng cao 11','2018-05',40000,'VH','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C006',N'Thực hành kỹ năng sống dành cho học sinh lớp 1','2015-08',21500,'KNS','GD')
...
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C008',N'Bình giảng 31 tác phẩm văn học Ngữ văn 6','2012-04',4000,'VH','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C009',N'Phương pháp luận nghiên cứu văn học','2012-05',79000,'VH','GD')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('C010',N'Lịch sử văn học Trung Quốc','2002-05',20000,'VH','GD')
...
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D005',N'Con ơi, ba mẹ vẫn chờ','2020',64000,'MVB','TH')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D006',N'Để làm gì - Tạp bút','2020',120000,'KNS','TH')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D007',N'Ngàn cánh sen xanh biếc','2020',50400,'KNS','TH')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D008',N'Con người trong vòng vây','2016',64000,'KNS','TH')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D009',N'Đắc nhân tâm - Bản đặc biệt','2019-04',150000,'KNS','DT')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('D010',N'Hỏi xoắn đáp cong','2017-10',76000,'KNS','DT')


INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E001',N'Cuộc chơi khởi nghiệp','2012-12',109000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E002',N'Kiếm tiền siêu tốc','2013-05',110000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E003',N'Tiếng Trung giao tiếp trong kinh doanh đặt hàng buôn bán','2020-05',139000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E004',N'Sách của những câu hỏi','2016-05',68500,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E005',N'Người thành công có 1% suy nghĩ khác bạn','2016-09',80000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E006',N'Quyết tâm thành công sẽ tới','2017-04',60000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E007',N'Điểm mù - Tái bản','2017-03',89000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E008',N'Cuộc chơi đầu tư mạo hiểm','2013-06',85000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E009',N'Nghệ thuật lắng nghe trong giao tiếp','2020',129000,'KNS','TN')
INSERT INTO SACH(MASACH,TENSACH,NGAYIN,GIABAN,LOAI,NXB) VALUES ('E010',N'Cư xử như đàn bà, suy nghĩ như đàn ông - Tái bản 2017','2017-04',82000,'KNS','TN')
